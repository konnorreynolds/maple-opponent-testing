...
public class SmartOpponentConfig {
     ...
     * May or may not be used depending on the opponent's setup.
     *
     ...
     * @return this, for chaining.
     */
    public SmartOpponentConfig replaceBehaviourCommand(String behaviorName, Command newBehaviorCommand, boolean isDefault)
    {
        ...
        for (Map.Entry<String, Pair<Command, Boolean>> entry : behavior.entrySet()) {
            ...
            if (entry.getValue().getSecond())
            {
                ...
                if (hasDefault)
                {
                    ...
                    DriverStation.reportError("Behaviour Chooser has multiple defaults, ignoring future defaults.", false);
                ...
                else
                {
                    ...
                    behaviorChooser.setDefaultOption(entry.getKey(), entry.getValue().getFirst());
                    hasDefault = true;
                }}
            else
            {
    ...
    public static class ChassisConfig
    {
        ...
        /**
         * Default constructor for ChassisConfig.
         * Each Option must be set individually.
         */
        ChassisConfig() {
        ...
        public RobotConfig updatePathplannerConfig()
        {
            this.pathplannerConfig = new RobotConfig(
                    mass,
                    moi,
                    module.updatePathplannerModuleConfig(),
                    trackWidth);
        ...
        public boolean validConfig() {
            ...
            if (!validConfig) {
                for (ChassisOptions option : requiredChassisOptions) {
                    DriverStation.reportWarning("Required Option: " + option.toString() + " not set in ChassisConfig", false);
                }
            }
            // If any required options aren't removed, return false.
            return validConfig;
            ...
            public ChassisConfig getConfig() {
                return switch (this) {
                    ...
                    case SimpleSquareChassis -> new ChassisConfig()
                            ...
                            .withMaxAngularVelocity(RadiansPerSecond.of(Math.PI * 2))
    ...
    public static class ModuleConfig
    {
        ...
        /**
         * Empty constructor for ModuleConfig.
         * Each Option must be set individually.
         */
        ModuleConfig()
        {
        ...
        /**
         * Creates a new {@link SwerveModuleSimulation} from a {@link com.pathplanner.lib.config.ModuleConfig}.
        ...
        /**
         * Creates a new {@link com.pathplanner.lib.config.ModuleConfig} from a {@link com.pathplanner.lib.config.ModuleConfig}.
         *
        ...
        public boolean validConfig() {
            ...
            if (!validConfig) {
                for (ModuleOptions option : requiredModuleOptions) {
                    DriverStation.reportError("Required Option: " + option.toString() + " not set in ModuleConfig", false);
                }
            }
            return validConfig;
        }
         ...
         */
        public static ModuleConfig clone(ModuleConfig other) { return new ModuleConfig().copy(other); }
    }
}